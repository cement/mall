...
import com.changqing.medication.views.genre.GenreNaviListAdapter;
import com.changqing.medication.views.genre.GenreViewPagerAdapter;
...
public class GenreActivity extends AppCompatActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mGenreContent.setAdapter(new GenreViewPagerAdapter(getSupportFragmentManager(),R.layout.genre_content_item_layout,Constant.getGenreData()));
	}
